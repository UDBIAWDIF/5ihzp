...
var city='<?echo $addr;?>';
city = city.split(' ');
if(city[0].indexOf("福州")>=0) {
	window.location.href="http://fz.demo.com/";
}
*/
...
class IpCity {
	 ...
	 * @return string
	 */
	public function getCity($userip, $data_path = '') {
		empty($data_path) && $data_path = $this->_data_path;
		empty($data_path) && $data_path = 'QQWry.Dat';
		...
		if(preg_match('/http/i', $useripaddr) || $useripaddr == '') {
			$useripaddr = 'No Data';
		} elseif(!$this->_is_utf8($useripaddr)) {
