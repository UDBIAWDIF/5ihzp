...
jQuery.dump = function (object, showTypes, showAttributes) {
	...
	var _recurse = function (o, type) {
		...
		case 'domelement':
			...
			if (sa) {
				for (i in o) {
					if (!/innerHTML|outerHTML/i.test(i)) {
						attr += i + ': ' + o[i] + '<br />';
					}
				}
			}
	...
	var _dumpStyles = function (type, use) {
		var r = '';
		var table = 'font-family:verdana,arial,helvetica,sans-serif;cell-spacing:2px;';
		var th = 'font-family:verdana,arial,helvetica,sans-serif;text-align:left;color: white;padding: 5px;vertical-align :top;cursor:hand;cursor:pointer;';
		var td = 'font-family:verdana,arial,helvetica,sans-serif;vertical-align:top;padding:3px;';
